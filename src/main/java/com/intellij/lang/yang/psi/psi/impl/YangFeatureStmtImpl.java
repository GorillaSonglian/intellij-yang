...
public class YangFeatureStmtImpl extends ASTWrapperPsiElement implements YangFeatureStmt {

  public YangFeatureStmtImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof YangVisitor) ((YangVisitor)visitor).visitFeatureStmt(this);
