...
public class YangWhenStmtImpl extends ASTWrapperPsiElement implements YangWhenStmt {

  public YangWhenStmtImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof YangVisitor) ((YangVisitor)visitor).visitWhenStmt(this);
