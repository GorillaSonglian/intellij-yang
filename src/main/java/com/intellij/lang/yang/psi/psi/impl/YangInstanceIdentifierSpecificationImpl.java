...
public class YangInstanceIdentifierSpecificationImpl extends ASTWrapperPsiElement implements YangInstanceIdentifierSpecification {
  ...
  public YangInstanceIdentifierSpecificationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof YangVisitor) ((YangVisitor)visitor).visitInstanceIdentifierSpecification(this);
