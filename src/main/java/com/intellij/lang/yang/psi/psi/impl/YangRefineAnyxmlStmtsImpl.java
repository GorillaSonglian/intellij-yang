...
public class YangRefineAnyxmlStmtsImpl extends ASTWrapperPsiElement implements YangRefineAnyxmlStmts {

  public YangRefineAnyxmlStmtsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof YangVisitor) ((YangVisitor)visitor).visitRefineAnyxmlStmts(this);
