...
public class YangCaseStmtImpl extends ASTWrapperPsiElement implements YangCaseStmt {

  public YangCaseStmtImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof YangVisitor) ((YangVisitor)visitor).visitCaseStmt(this);
